...
# Defining the video source (replace with your own video file path)
video_path = "pathole.mp4"  # <-- Update this line with your video path
cap = cv.VideoCapture(video_path)  # Open the video file using the correct path
...
print("Inference complete. Results saved in 'result.avi' and pothole coordinates.")
